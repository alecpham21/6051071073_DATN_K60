...
@onready var graphic_seeding = $ModelCarrot/Seeding/Tilled_Ground
@onready var graphic_sapling = $ModelCarrot/Sapling
@onready var graphic_middle = $ModelCarrot/Middle
@onready var graphic_ready = $ModelCarrot/Ready
@onready var ground_mesh: MeshInstance3D = $ModelCarrot/Seeding/Tilled_Ground/Plane
