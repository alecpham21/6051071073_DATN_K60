...
@onready var graphic_seeding = $ModelWheat/Seeding/Tilled_Ground
@onready var graphic_sapling = $ModelWheat/Sapling
@onready var graphic_middle = $ModelWheat/Middle
@onready var graphic_ready = $ModelWheat/Ready
@onready var ground_mesh: MeshInstance3D = $ModelWheat/Seeding/Tilled_Ground/Plane
