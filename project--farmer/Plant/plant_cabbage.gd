...
# Model hierarchy y chang corn
@onready var graphic_seeding = $ModelCabbage/Seeding/Tilled_Ground
@onready var graphic_sapling = $ModelCabbage/Sapling
@onready var graphic_middle = $ModelCabbage/Middle
@onready var graphic_ready = $ModelCabbage/Ready
@onready var ground_mesh: MeshInstance3D = $ModelCabbage/Seeding/Tilled_Ground/Plane
